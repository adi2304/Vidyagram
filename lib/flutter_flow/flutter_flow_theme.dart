...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD3EFCE);
  late Color secondary = const Color(0xFFD4E26F);
  late Color tertiary = const Color(0xFFE7BD24);
  late Color alternate = const Color(0xFF97D9EE);
  late Color primaryText = const Color(0xFF018001);
  late Color secondaryText = const Color(0xFF16171A);
  late Color primaryBackground = const Color(0xFFACE3A3);
